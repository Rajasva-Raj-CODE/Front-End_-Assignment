...
import {ExamMotivationData} from './ExamMotivationData'
...
const ExamMotivation = () => {
  ...
  const visibleBlogs = showAll ? ExamMotivationData : ExamMotivationData.slice(0, 4);

  return (
    <div className="px-[40px] py-[20px]  " >
          <h1>exam-motivation</h1>
